<template>
  <section class="register">
    <h1>
      <span class="theme"> user-deatailes </span>
    </h1>
    ...
    <el-input class="input-model" placeholder="Reapeat password" type="password"> </el-input>
    <h1>
      <span class="theme"> profile </span>
    </h1>
    <el-input class="input-model" placeholder="Full name for ex` Inbar Svarzenberg" type="text"> </el-input>
    ...
    <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/" :on-preview="handlePreview" :on-remove="handleRemove" :file-list="fileList2" list-type="picture">
      ...
      <div slot="tip" class="el-upload__tip">jpg/png files with a size less than 500kb</div>
        ...
        <h1 span class="theme">match preferance</span></h1>
